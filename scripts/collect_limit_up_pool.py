...
def collect():
    ...
    return {"schema_version":"1.0","run_type":"limit_up_pool","status":"success","captured_at_cst":captured,"source":"Eastmoney.getTopicZTPool","source_native_timestamp_available":False,"record_count":len(records),"records":records}
